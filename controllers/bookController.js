...
exports.book_list = function(req, res) {
  Book.find({}).populate('author genre').exec(function (err, list_books) {
    if (err) { return next(err); }
    //Successful, so render
    res.render('lists/book_list', { title: 'Book List', book_list: list_books });
  });
};
...
exports.book_detail = function(req, res) {
  async.parallel({
    ...
    res.render('details/book_detail', { title: 'Title', book:  results.book, book_instances: results.book_instance } );
  });
};
